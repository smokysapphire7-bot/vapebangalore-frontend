...
export default function LostMaryBangalorePage() {
  return (
      ...
      <div className="container" style={{ paddingTop: "32px", paddingBottom: "100px" }}>
        <div style={{ marginBottom: "32px" }}>
          ...
          <a href={WHATSAPP.orderLink("Lost Mary vape")} target="_blank" rel="noopener noreferrer"
            ...
            Order Lost Mary on WhatsApp
          </a>
        </div>
        <h2 style={{ fontFamily: "var(--font-bebas)", fontSize: "24px", color: "var(--white)", marginBottom: "16px", letterSpacing: "0.02em" }}>ALL LOST MARY PRODUCTS</h2>
