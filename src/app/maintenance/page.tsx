  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>We'll Be Back Soon — VapeBangalore</title>
        <style>{`
      ...
      <body>
        <div className="card">
          ...
          <p>We are taking a short break to improve our service. We will be back shortly. In the meantime you can still reach us on WhatsApp for orders.</p>
