...
export default function Navigation() {
  ...
  const tabLinks = [
    ...
    { href: TELEGRAM.botUrl + "?start=order", label: "Telegram", icon: "tg", external: true },
    { href: "https://wa.me/916282878843?text=Hi%20VapeBangalore%2C%20I%20want%20to%20order.", label: "WhatsApp", icon: "wa", external: true },
          ...
          if (item.icon === "tg") {
            return (
              <a key={item.label} href={item.href} target="_blank" rel="noopener noreferrer" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "2px", textDecoration: "none", padding: "8px 4px" }}>
                <div style={{ width: "36px", height: "30px", borderRadius: "8px", background: "linear-gradient(135deg, #FF5C00, #FF2D55)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z"/></svg>
                </div>
                <span style={{ fontSize: "9px", fontWeight: 700, color: "var(--orange)" }}>Telegram</span>
              </a>
            );
          }
          if (item.icon === "wa") {
            return (
              <a key={item.label} href={item.href} target="_blank" rel="noopener noreferrer" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "2px", textDecoration: "none", padding: "8px 4px" }}>
                <div style={{ width: "36px", height: "30px", borderRadius: "8px", background: "rgba(37,211,102,0.15)", border: "1px solid rgba(37,211,102,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <span style={{ fontSize: "9px", fontWeight: 700, color: "#25D366" }}>WhatsApp</span>
              </a>
            );
          }
          return (
